...
function createVisualizer(){
  ...
  dataArray.forEach((item, index) => {
      ...
      canvasContext.fillRect(x*4, height - y , barWidth*2, y*8)
  })
  ...
  return (
    ...
    <div className="row " >
        ...
        <Routes>
          ...
          <div className = "container" style={{overflowY:"clip",  paddingTop:"1em", display:{showSearch}}}>
            <Form.Control
            type="search"
